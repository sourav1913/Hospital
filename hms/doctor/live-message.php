...
function getfee(val) {
	...
	<body style="background:url('assets/images/1.jpg') no-repeat;background-size:cover;">
		<div id="app">		
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Live Message</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Patient</span>
						...
						<div class="chatbox">
							<div class="chatlog">
								...
								<div class="chat doctor">
									<p class="chat-message">Whats Yours Problem</p>
								</div>
							</div>
							<div class="chat-form">
								<textarea></textarea>
