...
<html lang="en">
	...
	<body style="background:url('assets/images/2.jpeg') no-repeat;background-size:cover;">
		<div id="app">		
...
?>
	...
	<input type="text" name="Doctorspecialization" class="form-control" value="<?php echo htmlentities($data['specilization']);?>" >
														</div>
