...
<html lang="en">
	...
	<body style="background:url('assets/images/0.jpeg') no-repeat;background-size:cover;">
		<div id="app">		
...
{
?>
											Total Message :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
											</p>
										</div>
									</div>
